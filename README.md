...
Under the Chemical Engineering Department's AI guidance (August 2026) student use of AI in elective courses is "permitted as defined in the course" — so what follows is the definition for this course.
It supplements the Provost's [Standards for the Use of Generative AI in Teaching and Learning](https://provost.northeastern.edu/wp-content/uploads/2025/07/Standards-and-Recommendations-for-the-Use-of-Generative-AI-in-Teaching-and-Learning-at-Northeastern-FINAL-07.01.25.pdf); my own use of these tools is additionally governed by Northeastern's [Policy 125](https://policies.northeastern.edu/policy125/) on the Use of Artificial Intelligence Systems.
